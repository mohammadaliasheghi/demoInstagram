...
public class FollowUsersRestController {
    ...
    // http://localhost:8085/demoInstagram/api/follow-users/get-all-following/1
    ...
    // http://localhost:8085/demoInstagram/api/follow-users/count-all-follower/1
    ...
    // http://localhost:8085/demoInstagram/api/follow-users/get-all-follower/1
